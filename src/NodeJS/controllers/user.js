...
const createUser = async (req, res) => {
    try
    {
        ...
        if (req.body.watchedMovies && new Set(req.body.watchedMovies).size !== req.body.watchedMovies.length) {
            return res.status(400).json({ error: 'Duplicate movies are not allowed' });
        }
...
module.exports = { 
    createUser, getUser, isUserRegistered
};